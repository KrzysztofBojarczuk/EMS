...
{
    public record GetTransactionByBudgetIdQuery(Guid budgetId) : IRequest<IEnumerable<TransactionEntity>>;
        ...
        : IRequestHandler<GetTransactionByBudgetIdQuery, IEnumerable<TransactionEntity>>
    {
        ...
        {
            return await transactionRepository.GetTransactionsByBudgetIdAsync(request.budgetId);
        }
    }
}
