...
{
    public record GetAllEmployeesQuery(int pageNumber, int pageSize, string searchTerm, string sortOrder) : IRequest<PaginatedList<EmployeeEntity>>;

    public class GetAllEmployeesQueryHandler(IEmployeeRepository employeeRepository) : IRequestHandler<GetAllEmployeesQuery, PaginatedList<EmployeeEntity>>
    {
