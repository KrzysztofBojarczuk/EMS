...
namespace EMS.APPLICATION.Features.Employee.Queries
{
    ...
    public class GetUserEmployeeListsQueryHandler(IEmployeeRepository employeeRepository) : IRequestHandler<GetUserEmployeeListsQuery, IEnumerable<EmployeeListsEntity>>
    {
