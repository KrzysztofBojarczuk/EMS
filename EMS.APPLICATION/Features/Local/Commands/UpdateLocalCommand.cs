...
{
    public record UpdateLocalCommand(Guid LocalId, string appUserId, LocalEntity Local)
        : IRequest<LocalEntity>;

    public class UpdateLocalCommandHandler(ILocalRepository localRepository)
        : IRequestHandler<UpdateLocalCommand, LocalEntity>
    {
