...
{
    public record GetUserReservationQuery(string appUserId, int pageNumber, int pageSize, string searchTerm, string sortOrderDate) : IRequest<PaginatedList<ReservationEntity>>;
