...
namespace EMS.CORE.Interfaces
{
    public interface IVehicleRepository
    {
        ...
        Task<PaginatedList<VehicleEntity>> GetUserVehiclesAsync(string appUserId, int pageNumber, int pageSize, List<VehicleType> vehicleType, string searchTerm, DateTime? dateFrom, DateTime? dateTo, string sortOrderDate, string sortOrderMileage);
