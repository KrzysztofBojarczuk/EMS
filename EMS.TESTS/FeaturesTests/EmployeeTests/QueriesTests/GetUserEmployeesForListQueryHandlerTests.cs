    ...
    public class GetUserEmployeesForListQueryHandlerTests
    {
        ...
        public async Task Handle_Returns_AllEmployees()
        {
            ...
            var expectedEmployees = new List<EmployeeEntity>
            {
                ...
                new EmployeeEntity { Id = Guid.NewGuid(), Name = "Johnny", Email = "johnny@example.com", Phone = "123-456-789", Salary = 5000, DateOfBirth = new DateTime(1991, 1, 1), EmploymentDate = new DateTime(2022, 2, 2), MedicalCheckValidUntil = new DateTime(2025, 2, 2) },
