    ...
    public static class SeedData
    {
        public static async Task SeedUser(IServiceProvider serviceProvider)
        {
            ...
            if (!context.Employees.Any() && !context.Vehicles.Any() && !context.Address.Any() && !context.Tasks.Any())
            {
                ...
                {
                    new EmployeeEntity { Name = "John Doe", Email = "john.doe@example.com", Phone = "123-456-789", Salary = 5000, DateOfBirth = new DateTime(1990, 1, 1), EmploymentDate = new DateTime(2018, 5, 1), MedicalCheckValidUntil = new DateTime(2025, 5, 1), AppUserId = johnUser.Id },
                    new EmployeeEntity { Name = "Jane Smith", Email = "jane.smith@example.com", Phone = "987-654-321", Salary = 5500, DateOfBirth = new DateTime(1991, 1, 1), EmploymentDate = new DateTime(2019, 3, 15), MedicalCheckValidUntil = new DateTime(2025, 3, 15), AppUserId = johnUser.Id },
                    new EmployeeEntity { Name = "Michael Johnson", Email = "michael.johnson@example.com", Phone = "456-789-123", Salary = 6000, DateOfBirth = new DateTime(1992, 1, 1), EmploymentDate = new DateTime(2017, 7, 20), MedicalCheckValidUntil = new DateTime(2024, 7, 20), AppUserId = johnUser.Id },
                    new EmployeeEntity { Name = "Sarah Lee", Email = "sarah.lee@example.com", Phone = "321-654-987", Salary = 6200, DateOfBirth = new DateTime(1993, 1, 1), EmploymentDate = new DateTime(2020, 1, 10), MedicalCheckValidUntil = new DateTime(2025, 1, 10), AppUserId = johnUser.Id },
                    new EmployeeEntity { Name = "David Brown", Email = "david.brown@example.com", Phone = "789-123-456", Salary = 6500, DateOfBirth = new DateTime(1994, 1, 1), EmploymentDate = new DateTime(2016, 9, 30), MedicalCheckValidUntil = new DateTime(2024, 9, 30), AppUserId = johnUser.Id },
                    new EmployeeEntity { Name = "Emily White", Email = "emily.white@example.com", Phone = "159-357-468", Salary = 6800, DateOfBirth = new DateTime(1994, 1, 1), EmploymentDate = new DateTime(2021, 2, 12), MedicalCheckValidUntil = new DateTime(2026, 2, 12), AppUserId = johnUser.Id },
                    new EmployeeEntity { Name = "Daniel Green", Email = "daniel.green@example.com", Phone = "753-159-246", Salary = 7000, DateOfBirth = new DateTime(1995, 1, 1), EmploymentDate = new DateTime(2015, 11, 5), MedicalCheckValidUntil = new DateTime(2024, 11, 5), AppUserId = johnUser.Id },
                    new EmployeeEntity { Name = "Laura Black", Email = "laura.black@example.com", Phone = "246-813-579", Salary = 7200, DateOfBirth = new DateTime(1996, 1, 1), EmploymentDate = new DateTime(2017, 6, 22), MedicalCheckValidUntil = new DateTime(2024, 6, 22), AppUserId = johnUser.Id },
                    new EmployeeEntity { Name = "James Clark", Email = "james.clark@example.com", Phone = "963-258-741", Salary = 7400, DateOfBirth = new DateTime(1997, 1, 1), EmploymentDate = new DateTime(2016, 12, 18), MedicalCheckValidUntil = new DateTime(2024, 12, 18), AppUserId = johnUser.Id },
                    new EmployeeEntity { Name = "Olivia Harris", Email = "olivia.harris@example.com", Phone = "369-741-258", Salary = 7600, DateOfBirth = new DateTime(1998, 1, 1), EmploymentDate = new DateTime(2019, 9, 30), MedicalCheckValidUntil = new DateTime(2025, 9, 30), AppUserId = johnUser.Id }
                };
                ...
                {
                    new AddressEntity { Id = Guid.NewGuid(), City = "New York", Street = "5th Avenue", Number = "101", ZipCode = "10-001", AppUserId = johnUser.Id },
                    new AddressEntity { Id = Guid.NewGuid(), City = "Los Angeles", Street = "Sunset Boulevard", Number = "202", ZipCode = "90-001", AppUserId = johnUser.Id },
                    new AddressEntity { Id = Guid.NewGuid(), City = "Chicago", Street = "Michigan Avenue", Number = "303", ZipCode = "60-601", AppUserId = johnUser.Id },
                    new AddressEntity { Id = Guid.NewGuid(), City = "Houston", Street = "Main Street", Number = "404", ZipCode = "77-001", AppUserId = johnUser.Id },
